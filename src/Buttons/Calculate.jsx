...
export default function Calculate({ setActivePage }) {
    return(
        <>
            <div className=" rounded-md hover:bg-slate-500 hover:text-white dark:hover:text-gray-200 mx-3 max-md:mx-12 hover:shadow-lg hover:scale-105 transition-all duration-300 ease-in-out">
