        ...
        <>
            {!user?.displayName ? (
                ...
                <div className="relative mx-3 max-md:mx-12">
                    ...
                    {dropdownOpen && (
                        <div
                            className={`absolute bottom-full mb-2 w-full rounded-md shadow-lg bg-slate-300 dark:bg-slate-800 hover:dark:bg-slate-800 text-black dark:text-gray-200 animate-fadeIn hover:scale-105 transition-all duration-300 ease-in-out`}
                        >
                            <button
                                onClick={handleLogOut}
                                className="w-full rounded-md hover:bg-slate-500 hover:text-white hover:dark:bg-slate-900 dark:bg-slate-800 dark:text-gray-200 transition-colors duration-300 ease-in-out flex items-center h-10 justify-center"
                            >
                                Logout
                            </button>
                        </div>
