...
export default function Stats({ setActivePage }) {
    return(
        <>
            <div className=" rounded-md hover:bg-slate-500 hover:text-white hover:dark:bg-slate-800 mx-3 max-md:mx-12 hover:shadow-lg hover:scale-105 transition-all duration-300 ease-in-out">
